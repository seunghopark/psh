...
public class SubActivityNL extends Activity implements View.OnClickListener{

	private static final String TYPEFACE_NAME = "fonts/NanumGothicLight.ttf";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		txt.setText("승호가 만든 폰트 비교하기 NanumGothicLight");
